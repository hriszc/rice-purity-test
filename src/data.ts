...
export const sections: Section[] = [
  {
    title: "General",
    questions: [
      { text: "Kissed a member of the opposite sex", emoji: "💋", category: "romance", probability: 85 },
      { text: "French kissed a member of the opposite sex", emoji: "👅", category: "romance", probability: 75 },
      { text: "Made out with a member of the opposite sex", emoji: "💑", category: "romance", probability: 70 },
      { text: "Scrogged (naked making out) with a member of the opposite sex", emoji: "🔥", category: "romance", probability: 45 },
      { text: "Cunnilingus with a member of the opposite sex", emoji: "🍭", category: "experience", probability: 35 },
      { text: "Fellatio with a member of the opposite sex", emoji: "🍦", category: "experience", probability: 38 },
      { text: "69 with a member of the opposite sex", emoji: "♋", category: "experience", probability: 20 },
